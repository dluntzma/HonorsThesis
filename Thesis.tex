...
This senior thesis is the first year of a three year project designed to optically produce metastable krypton atoms for purposes of Atom Trap Trace Analysis (ATTA). ATTA involves using 215 nm light for a two photon transition 
...
Based on these results, we decided to use a $200$ mm lens which should give us a beam waist of $\approx 4$ mm. When we measured the light after installing the lens we got... 
