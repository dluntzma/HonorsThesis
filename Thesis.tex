...
The laser is scanned by changing the length of the reference cavity. When the length of the reference cavity matches the frequency of the atomic transition an error signal is created. The error signal arises because the rubidium atoms obey the Maxwell velocity distribution. Atoms traveling to the left perceive the $2 \mu$W beam, which is moving left to right, at a higher frequency (blue shifted) so they are less likely to be excited than atoms that are not moving because to them the photon energy is not on resonance. But some of the photons are still excited lowering the number of atoms reaching the photodiode. Similarly, atoms traveling to the right experience a lower frequency of the laser (red shifted) and so less of them are excited. This is the standard Doppler effect. However, when atoms are not moving the laser photon energy should be on resonance and the most atoms excited, meaning the smallest intensity at the photodiode. But there is the $400 \mu$W beam traveling in the opposite direction. The higher intensity of the $400 \mu$W beam means that atoms that are not moving are more likely to be excited by photons from the $400 \mu$W beam than the $2 \mu$W beam because there are so many more of them. That means that instead of an intensity drop at the photodiode, there is a peak because the $400 \mu$W beam is exciting atoms so more photons from the lower power beam are reaching the photodiode. This create a curve characteristic of the Doppler effect, but with a sharp peak at the atomic transition frequency of rubidium. The reference signal, provided by the other $2 \mu$W beam, is just the Doppler shift, without the peak at the resonant frequency. It can be used to subtract the Doppler effect from the error signal leaving a single peak at the transition frequency of the rubidium.
