...
To avoid measuring the blue light with the power meter, we measured the effective beam waists at various $z$ locations directly using a ruler. This was a rougher measurement, much more susceptible to systematic error due to parallax when measuring the waist. However it was a relatively simple measurement that we could preform quickly and see the results were usable. The results we obtained are in Figures~\ref{WaistFit}. 
...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Close-up results of waist measurements plotted }
  \label{WaistFitS}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
